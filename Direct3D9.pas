...
(*)
 ...
 [ History :
 [----------
 [ 27-May-2004 (Tim Baumgarten) : IDirect3DSurface9.GetContainer - const riid
 [ 27-May-2004 (Tim Baumgarten) : fixed IDirect3DDevice9.CreateVertexDeclaration
...
(*)
  ...
  IDirect3DDevice9 = interface (IUnknown)
    ...
    function CreateVertexDeclaration(VertexElements : PD3DVertexElement9; out Decl : IDirect3DVertexDeclaration9) : HResult; stdcall;
  ...
  IDirect3DSurface9 = interface (IDirect3DResource9)
    ...
    function GetContainer(const riid : TGUID; out Container : Pointer) : HResult; stdcall;
